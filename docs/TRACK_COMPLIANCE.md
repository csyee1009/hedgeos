...
| :--- | :--- | :--- | :--- |
| **Real LLM Intent Compiler** | Real Gemini 3.7 Flash (`gemini-3.7-flash`) integration | `src/providers/RealLLMIntentProvider.ts` | Natural language parsed to structured financial parameters |
