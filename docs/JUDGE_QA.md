...
### 5. Why use Gemini?
We use the configured Gemini model for structured JSON extraction and provenance grounding. The UI and API report the model actually selected at runtime.
